...
try{
	...
	if($payment_status == "successful" OR  $payment_status =="failed" )
	{
		...
		if($payment_status == "successful")
		{
            ...
            $currencyCode =  mysql_fetch_array(select_query("tblcurrencies", "code", array("id"=>$currency_id)));

			instamojo_logger(print_r($currency, true));
			$convertedPaymentAmount = currency_converter($paymentAmount, 'INR', $currencyCode['code']);
